...
ns-xxx.awsdns-xx.com ns-xxx.awsdns-xx.net ns-xxx.awsdns-xx.org ns-xxx.awsdns-xx.co.uk
...
Field Value Record name (leave empty) Record type A Alias ON Route traffic to Application Load Balancer Region us-east-1 Load balancer your-alb.amazonaws.com
...
Field Value Record name www Record type CNAME Value your-alb.amazonaws.com
...
Field Value Protocol HTTPS Port 443 Certificate Select ACM certificate Default action Forward to target group
...
Setting Value Target type Instances Protocol HTTP Port 80 Health check path /
...
Field Value Path / Healthy threshold 2 Unhealthy threshold 2 📊 Step 11: Enable ALB Access Logs
...
🧠 Final Architecture vineethsworld.xyz ↓ Route 53 ↓ ALB (HTTPS 443) ↓ Target Group ↓ EC2
